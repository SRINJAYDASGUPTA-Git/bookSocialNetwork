...
export class BookService extends BaseService {
   ...
   */
  uploadBookCoverPicture$Response(params: UploadBookCoverPicture$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
   ...
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  uploadBookCoverPicture(params: UploadBookCoverPicture$Params, context?: HttpContext): Observable<number> {
  ...
  static readonly UpdateArchivedStatusPath = '/books/archive/{book-id}';
